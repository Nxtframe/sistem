...
class Employee extends Model {
  ...
  EmployeeModelIdentifier get modelIdentifier {
    return EmployeeModelIdentifier(id: id);
  }
  ...
  const Employee._internal(
      ...
      employee_phone,
      employee_created,
      organizationIDtoEmployeeRelation,
      createdAt,
      updatedAt})
      : _employee_role = employee_role,
        _employee_organization = employee_organization,
        _employee_email = employee_email,
        _employee_phone = employee_phone,
        _employee_created = employee_created,
        _organizationIDtoEmployeeRelation = organizationIDtoEmployeeRelation,
  ...
  factory Employee(
      ...
      int? employee_phone,
      String? employee_created,
      String? organizationIDtoEmployeeRelation}) {
  ...
  bool operator ==(Object other) {
    ...
    return other is Employee &&
        ...
        _organizationIDtoEmployeeRelation ==
            other._organizationIDtoEmployeeRelation;
  }
  ...
  String toString() {
    ...
    buffer.write("employee_phone=" +
        (_employee_phone != null ? _employee_phone!.toString() : "null") +
        ", ");
    buffer.write("employee_created=" + "$_employee_created" + ", ");
    buffer.write("organizationIDtoEmployeeRelation=" +
        "$_organizationIDtoEmployeeRelation" +
        ", ");
  ...
  Employee copyWith(
    ...
    return Employee._internal(
        ...
        employee_organization:
            employee_organization ?? this.employee_organization,
        ...
        organizationIDtoEmployeeRelation: organizationIDtoEmployeeRelation ??
            this.organizationIDtoEmployeeRelation);
  }
  ...
  Employee.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _organizationIDtoEmployeeRelation =
            json['organizationIDtoEmployeeRelation'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'employee_organization': _employee_organization,
        'employee_email': _employee_email,
        'employee_phone': _employee_phone,
        'employee_created': _employee_created,
        'organizationIDtoEmployeeRelation': _organizationIDtoEmployeeRelation,
  ...
  static final QueryModelIdentifier<EmployeeModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<EmployeeModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField EMPLOYEE_ROLE =
      QueryField(fieldName: "employee_role");
  static final QueryField EMPLOYEE_ORGANIZATION =
      QueryField(fieldName: "employee_organization");
  static final QueryField EMPLOYEE_EMAIL =
      QueryField(fieldName: "employee_email");
  static final QueryField EMPLOYEE_PHONE =
      QueryField(fieldName: "employee_phone");
  static final QueryField EMPLOYEE_CREATED =
      QueryField(fieldName: "employee_created");
  static final QueryField ORGANIZATIONIDTOEMPLOYEERELATION =
      QueryField(fieldName: "organizationIDtoEmployeeRelation");
  static var schema =
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(
          fields: const ["organizationIDtoEmployeeRelation"],
          name: "byOrganization")
    ];
...
class EmployeeModelIdentifier implements ModelIdentifier<Employee> {
  ...
  const EmployeeModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is EmployeeModelIdentifier && id == other.id;
  }
