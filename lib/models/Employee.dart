...
class Employee extends Model {
  ...
  final List<PurchaseOrders>? _purchaseOrders;
  ...
  List<PurchaseOrders>? get purchaseOrders {
  ...
  const Employee._internal({required this.id, employee_role, employee_organization, employee_email, employee_phone, employee_created, organizationIDtoEmployeeRelation, purchaseOrders, createdAt, updatedAt}): _employee_role = employee_role, _employee_organization = employee_organization, _employee_email = employee_email, _employee_phone = employee_phone, _employee_created = employee_created, _organizationIDtoEmployeeRelation = organizationIDtoEmployeeRelation, _purchaseOrders = purchaseOrders, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Employee({String? id, String? employee_role, String? employee_organization, String? employee_email, int? employee_phone, String? employee_created, String? organizationIDtoEmployeeRelation, List<PurchaseOrders>? purchaseOrders}) {
    return Employee._internal(
      ...
      purchaseOrders: purchaseOrders != null ? List<PurchaseOrders>.unmodifiable(purchaseOrders) : purchaseOrders);
  }
  ...
  Employee copyWith({String? employee_role, String? employee_organization, String? employee_email, int? employee_phone, String? employee_created, String? organizationIDtoEmployeeRelation, List<PurchaseOrders>? purchaseOrders}) {
    return Employee._internal(
      id: id,
    ...
    : id = json['id'],
      ...
      _purchaseOrders = json['purchaseOrders'] is List
        ? (json['purchaseOrders'] as List)
          ...
          .map((e) => PurchaseOrders.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'employee_role': _employee_role, 'employee_organization': _employee_organization, 'employee_email': _employee_email, 'employee_phone': _employee_phone, 'employee_created': _employee_created, 'organizationIDtoEmployeeRelation': _organizationIDtoEmployeeRelation, 'purchaseOrders': _purchaseOrders?.map((PurchaseOrders? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
      key: Employee.PURCHASEORDERS,
      isRequired: true,
      ofModelName: 'PurchaseOrders',
      associatedKey: PurchaseOrders.EMPLOYEEID
    ));
